...
//go:embed scenario-create-secret-type.yaml
var scenarioCreateSecretTypeYAML string

func TestCreateSecretTypeDocker(t *testing.T) {
    ...
    if err := test.RunScenario(t, "create-secret-type", scenarioCreateSecretTypeYAML, factory); err != nil {
        t.Fatalf("Scenario failed: %v", err)
    }
}

func TestCreateSecretTypeInternal(t *testing.T) {
    factory := func(logger *log.Logger, pwd string, manifestReader io.Reader, output io.Writer) (pkg.Package, error) {
