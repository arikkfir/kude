...
//go:embed scenario-label-with-inline-values.yaml
var scenarioLabelWithInlineValuesYAML string

func TestLabelWithInlineValuesDocker(t *testing.T) {
    ...
    if err := test.RunScenario(t, "label-with-inline-values", scenarioLabelWithInlineValuesYAML, factory); err != nil {
        t.Fatalf("Scenario failed: %v", err)
    }
}

func TestLabelWithInlineValuesInternal(t *testing.T) {
    factory := func(logger *log.Logger, pwd string, manifestReader io.Reader, output io.Writer) (pkg.Package, error) {
