...
var (
	...
	builtinFunctionsMapping = map[string]func() functions.Function{
		...
		"ghcr.io/arikkfir/kude/functions/helm":             func() functions.Function { return &functions.HelmCommand{} },
		"ghcr.io/arikkfir/kude/functions/helm-install":     func() functions.Function { return &functions.Helm{} },
