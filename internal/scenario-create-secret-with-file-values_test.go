...
var CreateSecretWithFileValuesYAML string

func TestCreateSecretWithFileValues(t *testing.T) {
	s, err := scenario.OpenScenario("TestCreateSecretWithFileValues", strings.NewReader(CreateSecretWithFileValuesYAML))
	if err != nil {
