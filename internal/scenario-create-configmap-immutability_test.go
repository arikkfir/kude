...
var CreateConfigmapImmutabilityYAML string

func TestCreateConfigmapImmutability(t *testing.T) {
	s, err := scenario.OpenScenario("TestCreateConfigmapImmutability", strings.NewReader(CreateConfigmapImmutabilityYAML))
	if err != nil {
