...
var LabelWithInlineValuesYAML string

func TestLabelWithInlineValues(t *testing.T) {
	s, err := scenario.OpenScenario("TestLabelWithInlineValues", strings.NewReader(LabelWithInlineValuesYAML))
	if err != nil {
