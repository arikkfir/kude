...
var ImportGithubPackageYAML string

func TestImportGithubPackage(t *testing.T) {
	s, err := scenario.OpenScenario("TestImportGithubPackage", strings.NewReader(ImportGithubPackageYAML))
	if err != nil {
