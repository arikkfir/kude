...
var EmptyPipelineFormattingYAML string

func TestEmptyPipelineFormatting(t *testing.T) {
	s, err := scenario.OpenScenario("TestEmptyPipelineFormatting", strings.NewReader(EmptyPipelineFormattingYAML))
	if err != nil {
