...
var CreateSecretTypeYAML string

func TestCreateSecretType(t *testing.T) {
	s, err := scenario.OpenScenario("TestCreateSecretType", strings.NewReader(CreateSecretTypeYAML))
	if err != nil {
