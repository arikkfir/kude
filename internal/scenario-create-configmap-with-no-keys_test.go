...
var CreateConfigmapWithNoKeysYAML string

func TestCreateConfigmapWithNoKeys(t *testing.T) {
	s, err := scenario.OpenScenario("TestCreateConfigmapWithNoKeys", strings.NewReader(CreateConfigmapWithNoKeysYAML))
	if err != nil {
