...
var ImportGithubFilesYAML string

func TestImportGithubFiles(t *testing.T) {
	s, err := scenario.OpenScenario("TestImportGithubFiles", strings.NewReader(ImportGithubFilesYAML))
	if err != nil {
