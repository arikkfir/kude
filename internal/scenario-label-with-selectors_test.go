...
var LabelWithSelectorsYAML string

func TestLabelWithSelectors(t *testing.T) {
	s, err := scenario.OpenScenario("TestLabelWithSelectors", strings.NewReader(LabelWithSelectorsYAML))
	if err != nil {
