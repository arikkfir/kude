...
var ImportGithubDirectoryYAML string

func TestImportGithubDirectory(t *testing.T) {
	s, err := scenario.OpenScenario("TestImportGithubDirectory", strings.NewReader(ImportGithubDirectoryYAML))
	if err != nil {
