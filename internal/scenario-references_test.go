...
//go:embed scenario-references.yaml
var scenarioReferencesYAML string

func TestReferencesDocker(t *testing.T) {
    ...
    if err := test.RunScenario(t, "references", scenarioReferencesYAML, factory); err != nil {
