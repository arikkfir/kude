...
var AnnotateWithFileValuesYAML string

func TestAnnotateWithFileValues(t *testing.T) {
	s, err := scenario.OpenScenario("TestAnnotateWithFileValues", strings.NewReader(AnnotateWithFileValuesYAML))
	if err != nil {
