...
var RenderChartWithLocalValuesFileYAML string

func TestRenderChartWithLocalValuesFile(t *testing.T) {
	s, err := scenario.OpenScenario("TestRenderChartWithLocalValuesFile", strings.NewReader(RenderChartWithLocalValuesFileYAML))
	if err != nil {
