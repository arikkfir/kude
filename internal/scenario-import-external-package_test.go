...
var ImportExternalPackageYAML string

func TestImportExternalPackage(t *testing.T) {
	s, err := scenario.OpenScenario("TestImportExternalPackage", strings.NewReader(ImportExternalPackageYAML))
	if err != nil {
