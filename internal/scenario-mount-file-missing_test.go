...
var MountFileMissingYAML string

func TestMountFileMissing(t *testing.T) {
	s, err := scenario.OpenScenario("TestMountFileMissing", strings.NewReader(MountFileMissingYAML))
	if err != nil {
