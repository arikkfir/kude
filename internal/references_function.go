...
func (r *referencesResolverFunction) Filter(resources []*yaml.RNode) ([]*yaml.RNode, error) {
...
func (r *referencesResolverFunction) collectRenamedResources(resources []*yaml.RNode) (map[string]string, error) {
