...
var SingleFunctionPipelineFormattingYAML string

func TestSingleFunctionPipelineFormatting(t *testing.T) {
	s, err := scenario.OpenScenario("TestSingleFunctionPipelineFormatting", strings.NewReader(SingleFunctionPipelineFormattingYAML))
	if err != nil {
