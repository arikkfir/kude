...
var ImportNestedSubdirYAML string

func TestImportNestedSubdir(t *testing.T) {
	s, err := scenario.OpenScenario("TestImportNestedSubdir", strings.NewReader(ImportNestedSubdirYAML))
	if err != nil {
