...
var AnnotateWithSelectorsYAML string

func TestAnnotateWithSelectors(t *testing.T) {
	s, err := scenario.OpenScenario("TestAnnotateWithSelectors", strings.NewReader(AnnotateWithSelectorsYAML))
	if err != nil {
